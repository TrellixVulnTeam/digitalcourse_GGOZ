...
export declare class ModalComponent<T = any, R = any> extends ModalRef<T, R> implements ControlValueAccessor {
    ...
    triggerCancel(): void;
    destroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ModalComponent<any, any>, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ModalComponent<any, any>, "Modal", never, { "title": "title"; "closable": "closable"; "maskClosable": "maskClosable"; "popup": "popup"; "animationType": "animationType"; "transparent": "transparent"; "footer": "footer"; "platform": "platform"; "className": "className"; "wrapClassName": "wrapClassName"; "actions": "actions"; "defaultValue": "defaultValue"; "type": "type"; "placeholders": "placeholders"; "operation": "operation"; }, { "onClose": "onClose"; "afterOpenEmitter": "afterOpenEmitter"; "afterCloseEmitter": "afterCloseEmitter"; }, never, ["*"]>;
}
export declare class ModalServiceComponent extends ModalComponent {
    option: ModalOptions;
    elementRef: ElementRef;
    constructor(option: ModalOptions, elementRef: ElementRef);
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ModalServiceComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ModalServiceComponent, "ModalService", never, {}, {}, never, ["*"]>;
}
