...
export declare class NoticeBarComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NoticeBarComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NoticeBarComponent, "NoticeBar, nzm-notice-bar", never, { "option": "option"; }, { "onClick": "onClick"; }, never, never>;
}
