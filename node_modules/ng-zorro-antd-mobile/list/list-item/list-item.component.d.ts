...
export declare class ListItemComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ListItemComponent, "ListItem, nzm-list-item", never, { "extra": "extra"; "className": "className"; "arrow": "arrow"; "multipleLine": "multipleLine"; "error": "error"; "wrap": "wrap"; "align": "align"; "platform": "platform"; "disabled": "disabled"; "thumb": "thumb"; }, { "onClick": "onClick"; }, never, ["*"]>;
}
