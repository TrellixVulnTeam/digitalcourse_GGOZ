...
export declare class PaginationComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PaginationComponent, "Pagination, nzm-pagination", never, { "mode": "mode"; "current": "current"; "total": "total"; "simple": "simple"; "disabled": "disabled"; "locale": "locale"; }, { "onChange": "onChange"; }, never, never>;
}
export {};
