...
export declare class AccordionComponent implements AfterContentInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<AccordionComponent, "Accordion, nzm-accordion", never, { "expandAll": "expandAll"; "openAnimation": "openAnimation"; "accordion": "accordion"; "activeKey": "activeKey"; "defaultActiveKey": "defaultActiveKey"; }, { "onChange": "onChange"; }, ["groups"], ["*"]>;
}
