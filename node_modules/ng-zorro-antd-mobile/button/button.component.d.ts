...
export declare class ButtonComponent implements AfterViewInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ButtonComponent, "[Button], nzm-button", never, { "type": "type"; "size": "size"; "disabled": "disabled"; "loading": "loading"; "inline": "inline"; "icon": "icon"; "className": "className"; }, { "onClick": "onClick"; }, never, ["img", "*"]>;
}
