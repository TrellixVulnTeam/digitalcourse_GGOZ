...
export declare class CustomKeyboardComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<CustomKeyboardComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<CustomKeyboardComponent, "CustomKeyboard", never, {}, { "onClick": "onClick"; }, never, never>;
}
