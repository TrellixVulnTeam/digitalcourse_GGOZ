...
export declare class TouchFeedbackDirective implements OnInit {
    ...
    touchStart(): void;
    touchEnd(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TouchFeedbackDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<TouchFeedbackDirective, "[TouchFeedbackDirective]", never, { "activeStyle": "activeStyle"; "className": "className"; }, { "clickStart": "clickStart"; "clickEnd": "clickEnd"; }, never>;
}
