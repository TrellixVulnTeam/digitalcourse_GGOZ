...
export declare class StepperComponent implements OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<StepperComponent, "Stepper, nzm-stepper", never, { "max": "max"; "min": "min"; "value": "value"; "step": "step"; "defaultValue": "defaultValue"; "disabled": "disabled"; "readOnly": "readOnly"; "showNumber": "showNumber"; }, { "onChange": "onChange"; }, never, never>;
}
