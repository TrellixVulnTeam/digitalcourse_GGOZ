...
export declare class ActionSheetComponent<T = any, R = any> extends ActionSheetRef<T, R> implements OnInit, OnDestroy {
    ...
    destroy(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ActionSheetComponent<any, any>, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ActionSheetComponent<any, any>, "ActionSheet", never, {}, {}, never, never>;
}
