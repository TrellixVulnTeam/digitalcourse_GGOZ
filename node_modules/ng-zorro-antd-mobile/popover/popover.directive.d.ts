...
export declare class PopoverDirective implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PopoverDirective, "[Popover], [nzm-popover]", never, { "mask": "mask"; "showArrow": "showArrow"; "visible": "visible"; "placement": "placement"; "overlay": "overlay"; "appendToBody": "appendToBody"; "className": "className"; "autoClose": "autoClose"; }, { "onVisibleChange": "onVisibleChange"; "onSelect": "onSelect"; }, never>;
}
