...
export declare class DatePickerDirective implements OnDestroy, OnChanges, OnInit, ControlValueAccessor {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DatePickerDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<DatePickerDirective, "[DatePicker]", never, { "minuteStep": "minuteStep"; "value": "value"; "disabled": "disabled"; "isOpen": "isOpen"; "mode": "mode"; "minDate": "minDate"; "maxDate": "maxDate"; "use12Hours": "use12Hours"; "mask": "mask"; "title": "title"; "okText": "okText"; "dismissText": "dismissText"; "locale": "locale"; "appendToBody": "appendToBody"; "showErrorToast": "showErrorToast"; "showErrorToastInterval": "showErrorToastInterval"; }, { "onVisibleChange": "onVisibleChange"; "onValueChange": "onValueChange"; "onOk": "onOk"; "onDismiss": "onDismiss"; }, never>;
}
